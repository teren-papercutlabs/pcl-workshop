...
If the participant is using Codex rather than Claude Code, explain that Codex CLI does not currently expose a `/plugin install` command. Use the clone-and-copy setup from the README instead.
